...
{ 
    ...
    G4Material   *SrcMat = nist->FindOrBuildMaterial("G4_He");    // Source's material
    G4Material   *DetMat = nist->FindOrBuildMaterial("G4_Be");  // Detector's Active Volume material
    ...
    Pos3 = G4ThreeVector(1*mm, 1*mm, 1*mm);  // Detector
    ...
    G4double SourceOutRad    = 0*mm;
    G4double SourceThickness = 0/2.*mm;
    ...
    G4double DetInnerRadius = 1*mm;
    G4double DetOuterRadius = 1*mm;
    G4double DetThickness   = 1/2.*mm;
